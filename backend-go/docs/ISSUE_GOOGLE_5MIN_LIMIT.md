...
- ลดโอกาสเสียงขาดช่วงด้วย ring buffer 1 วินาทีที่ replay ตอน reconnect; อาจเกิดข้อความซ้ำบริเวณรอยต่อและไม่รับประกันผลรู้จำแบบคำต่อคำ
...
| Pros             | Cons                          |
| ---------------- | ----------------------------- |
| ✅ ลดโอกาสเสียงขาดช่วง | ❌ ไม่รู้จังหวะที่ดีที่สุดสำหรับ reconnect |
...
| ✅ ออกแบบให้ reconnect โปร่งใสในกรณีปกติ      |              |
| ✅ ทำงานภายใน Google provider โดยไม่เปลี่ยน LiveKit transport |              |
...
| **Hybrid (isFinal)** | ต่ำ; อาจซ้ำช่วง replay | ~96KB  | ⭐⭐⭐        | ✅ ใช้แล้ว |
