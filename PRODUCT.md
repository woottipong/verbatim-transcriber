...
Calm, precise, and dependable. The product should feel like a capable production tool: quiet under pressure, explicit about system state, and exceptionally legible in Thai.

## Anti-references

Avoid flashy "AI dashboard" decoration, neon-heavy gradients, glassy cards, oversized status ornaments, and dense control-room interfaces that bury the transcript beneath controls. Do not make operational states depend on color alone.

## Design Principles

1. Keep the transcript as the operator's primary visual anchor.
...
Meet WCAG 2.1 AA contrast and keyboard-access expectations. Support reduced motion, use text and icons alongside color for state, maintain generous touch targets, and optimize line-height and spacing for Thai-script readability.
